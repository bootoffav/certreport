  ...
  constructor(state: any) {
    ...
    const companyProfile = {
      table: {
        widths: [120, '*'],
        body: [
          ['Applicant of report', { text: state.applicantName, fillColor: '#FFFF08' }],
      ...
      table: {
        ...
        body: [
          ...
          [
            'Weight',
            {
              text: state.product.slice(1 + state.product.lastIndexOf(',')).trim(),
    ...
    const testRequirement = {
      table: {
        ...
        body: [
          ...
          [
            {
              text: [this.renderProperSquare('testRequirement', 0, 'EN 11611'), ' EN 11611']
            },
            {
              text: [this.renderProperSquare('testRequirement', 0, 'A1'), ' A1'] },
            { text: [this.renderProperSquare('testRequirement', 0, 'A2'), ' A2'] },
            { text: '', colSpan: 5 }, {}, {}, {}, {},
            ''],
          [
            { text: [this.renderProperSquare('testRequirement', 1, 'EN 11612'), ' EN 11612'] },
            { text: [this.renderProperSquare('testRequirement', 1, 'A1'), ' A1'] },
            { text: [this.renderProperSquare('testRequirement', 1, 'A2'), ' A2'] },
            ...
            ''],
          [
            { text: [this.renderProperSquare('testRequirement', 2, 'EN 1149-5'), ' EN 1149-5'] },
            { text: [this.renderProperSquare('testRequirement', 2, 'EN 1149-1'), ' EN 1149-1'], colSpan: 2}, {},
            { text: [this.renderProperSquare('testRequirement', 2, 'EN 1149-3'), ' EN 1149-3'], colSpan: 2 }, {},
            { text: '', colSpan: 3 }, {}, {},
            ''
          ],
          [
            { text: [this.renderProperSquare('testRequirement', 3, 'EN 61482-1-2'), ' EN 61482-1-2'] },
            { text: [this.renderProperSquare('testRequirement', 3, 'Class 1'), ' Class 1'], colSpan: 2 }, {},
            { text: [this.renderProperSquare('testRequirement', 3, 'Class-2'), ' Class 2'], colSpan: 2 }, {},
            { text: '', colSpan: 3 }, {}, {},
            ''
          ],
          [
            { text: [this.renderProperSquare('testRequirement', 4, 'EN 20471'), ' EN 20471'] },
            { text: `According to Standard Mandotory Test Requirement`, colSpan: 7 }, {}, {}, {}, {}, {}, {},
            ''
          ],
          [
            { text: [this.renderProperSquare('testRequirement', 5, 'EN 14116'), ' EN 14116'] },
            { text: `According to Standard Mandotory Test Requirement`, colSpan: 7 }, {}, {}, {}, {}, {}, {},
            ''
          ],
          [
            { text: [this.renderProperSquare('testRequirement', 6, 'EN 343'), ' EN 343'] },
            { text: `According to Standard Mandotory Test Requirement`, colSpan: 7 }, {}, {}, {}, {}, {}, {},
            ''
          ],
          [
            { text: [this.renderProperSquare('testRequirement', 7, 'Other Standard 1'), ' Other Standard 1'] },
            {
              text: 
          ...
          [
            { text: [this.renderProperSquare('testRequirement', 8, 'Other Standard 2'), ' Other Standard 2'] },
            { text: `According to Standard Mandotory Test Requirement`, colSpan: 7 }, {}, {}, {}, {}, {}, {},
            ''
          ],
          [
      ...
      table: {
        ...
        body: [
          ...
          [
            ...
            { text: state.DBState.cycles[0], fillColor: '#FFFF08', alignment: 'center' },
            { text: `${state.DBState.washTemp}C`, fillColor: '#FFFF08', alignment: 'center' },
            { text: [this.renderProperSquare('washPreTreatment', 0, 'A'), ' A'], fillColor: '#FFFF08' },
            { text: [this.renderProperSquare('washPreTreatment', 0, 'B'), ' B'], fillColor: '#FFFF08' },
            { text: [this.renderProperSquare('washPreTreatment', 0, 'C'), ' C'], fillColor: '#FFFF08' },
            { text: [this.renderProperSquare('washPreTreatment', 0, 'D'), ' D'], fillColor: '#FFFF08' },
            { text: [this.renderProperSquare('washPreTreatment', 0, 'E'), ' E'], fillColor: '#FFFF08' },
            { text: [this.renderProperSquare('washPreTreatment', 0, 'F'), ' F'], fillColor: '#FFFF08' },
          ],
          [
            'Industrial Wash (ISO 15797)',
            { text: state.DBState.cycles[1], fillColor: '#FFFF08', alignment: 'center' },
            { text: 'According to standard', alignment: 'center' },
            {
              text: [this.renderProperSquare('washPreTreatment', 1, 'Tumble Dry'), ' Tumble Dry'],
              alignment: 'center', fillColor: '#FFFF08', colSpan: 3
            }, {}, {},
            {
              text: [this.renderProperSquare('washPreTreatment', 1, 'Tunnel Dry'), ' Tunnel Dry'],
              alignment: 'center', fillColor: '#FFFF08', colSpan: 3
            }, {}, {}
          ],
          [
      ...
      },
      {
        columns: [
          ...
          },
          {
            width: '*',
            text: [
              this.renderProperSquare('footer', 0, 'EUR'), ' EUR /   ',
              this.renderProperSquare('footer', 0, 'USD'), '   USD /   ',
              this.renderProperSquare('footer', 0, 'RMB'), '   RMB'
            ]
          }]
      }, {
        columns: [
          ...
          {
            width: '*',
            text: [ this.renderProperSquare('footer', 1, 'NO'), ' NO   /   ', this.renderProperSquare('footer', 1, 'Required'), '   Required' ]
        }]
      }, {
        text: [
